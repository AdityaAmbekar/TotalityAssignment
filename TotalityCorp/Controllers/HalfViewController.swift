...
class HalfViewController: UIViewController {
    ...
    var pageController: NextViewController!
    ...
    override func viewDidLoad() {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(HalfViewController.handleTap(_:)))
